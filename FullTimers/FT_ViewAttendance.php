...
<head>
    ...
    <title>View Attendance (FT)</title>
    ...
    <div class="middle-section">
        ...
        <div class="attendance-section">
            ...
            <div class="pagination">
                <a href="FT_ViewAttendance.php?page=<?php echo max(1, $page-1); ?>" class="<?php if ($page == 1) echo 'disabled'; ?>">&#9664;</a>
                ...
                if ($start_page > 1) {
                    echo '<a href="FT_ViewAttendance.php?page=1">1</a>';
                    if ($start_page > 2) {
                        echo '<span>...</span>';
                    }
                }
                ...
                for ($i = $start_page; $i <= $end_page; $i++):
                    ?>
                    <a href="FT_ViewAttendance.php?page=<?php echo $i; ?>" class="<?php if ($i == $page) echo 'active'; ?>"><?php echo $i; ?></a>
                <?php endfor;
                ...
                if ($end_page < $total_pages) {
                    ...
                    echo '<a href="FT_ViewAttendance.php?page=' . $total_pages . '">' . $total_pages . '</a>';
                }
                ?>

                <a href="FT_ViewAttendance.php?page=<?php echo min($total_pages, $page+1); ?>" class="<?php if ($page == $total_pages) echo 'disabled'; ?>">&#9654;</a>
            </div>
            <?php endif; ?>
        </div>
    </div>
