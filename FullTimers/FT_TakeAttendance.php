...
$sql_schedule = "SELECT StartWork, EndWork FROM schedule WHERE UserID = $user_id AND WorkDate = ?";
...
if ($hasWorkToday) {
    $sql_attendance = "SELECT ClockIn, ClockOut FROM attendance WHERE UserID = $user_id AND DATE(ClockIn) = ?";
