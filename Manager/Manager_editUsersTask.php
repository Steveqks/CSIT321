    ...
    if(isset($_POST['editTask'])) {
        ...
        if(isset($_POST['numstaff'])) {
            ...
            if ($numStaffTeam >= $numStaff) {
                        ...
                        if ($stmt->execute()) {
                            ...
                            if (count($PTUsers) > 0) {
                                ...
                                if (count($PTUsers) < $numStaff) {
                                    ...
                                    header("Location: Manager_viewTask.php?message=Task has been auto allocated.&maintaskid=".$mainTaskID);
                                    exit();
                ...
                header("Location: Manager_editUsersTask.php?error=There are ".$numStaffTeam." with ".$specialisationName." in ".$mainTeamName.". The indicated number of staff with the specialisation needed for the task is more than what is available in the team.&maintaskid=".$mainTaskID."&taskname=".$taskName."&taskdesc=".$taskDesc."&specialisationidname=".$specialisationIDName."&startdate=".$startDate."&enddate=".$endDate."&priority=".$priority."&autoallocate=".$autoallocate."&numstaffteam=".$numStaffTeam."&mainteamidname=".$teamIDName."&maintaskid=".$mainTaskID."&statusid=".$statusID);
                exit();
            }
