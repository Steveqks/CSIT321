<?php
	...
	if(isset($_POST['submit']))
	{
		...
		{
			header("Location: PT_SubmitReview.php?error=1 Review has already been submitted, please edit your existing review!.");
			 exit();
		}
		...
		else
		{
			...
			header("Location: PT_SubmitReview.php?message=Successfully updated your review!.");
			exit();
		}
	}
