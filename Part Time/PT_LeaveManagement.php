...
<head>
    ...
    <title>Leave Management(PT)</title>
    ...
    <div class="middle-section">
        ...
        <div class="leave-section">
			...
			<div class="leave-buttons">
                <a href="PT_ViewLeaves.php" class="leave-button">View My Leaves</a>
                <a href="PT_ApplyLeaves.php" class="leave-button">Apply For Leaves</a>
                <a href="PT_CancelLeaves.php" class="leave-button">Cancel My Leaves</a>
            </div>
        </div>
    </div>
</body>
