...
$sql_total = "SELECT COUNT(AttendanceID) FROM attendance WHERE UserID = 1";
...
$sql = "SELECT DATE(ClockIn) AS Date, TIME(ClockIn) AS StartTime, TIME(ClockOut) AS EndTime FROM attendance WHERE UserID = 1 LIMIT ?, ?";
    ...
    <div class="middle-section">
        ...
        <div class="attendance-section">
            ...
            <div class="pagination">
                <a href="view_atd_pt.php?page=<?php echo max(1, $page-1); ?>" class="<?php if ($page == 1) echo 'disabled'; ?>">&#9664;</a>
                ...
                if ($start_page > 1) {
                    echo '<a href="view_atd_pt.php?page=1">1</a>';
                    if ($start_page > 2) {
                        echo '<span>...</span>';
                    }
                }
                ...
                for ($i = $start_page; $i <= $end_page; $i++):
                    ?>
                    <a href="view_atd_pt.php?page=<?php echo $i; ?>" class="<?php if ($i == $page) echo 'active'; ?>"><?php echo $i; ?></a>
                <?php endfor;
                ...
                if ($end_page < $total_pages) {
                    ...
                    echo '<a href="view_atd_pt.php?page=' . $total_pages . '">' . $total_pages . '</a>';
                }
                ?>

                <a href="view_atd_pt.php?page=<?php echo min($total_pages, $page+1); ?>" class="<?php if ($page == $total_pages) echo 'disabled'; ?>">&#9654;</a>
            </div>
        </div>
    </div>
</body>
